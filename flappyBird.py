...
def welcomeScreen():
    ...
    # it will show welcome screen to user to make the game more interactive and intersting
    ...
    while True:
        for event in pygame.event.get():
            ...
            if playbutton.collidepoint(pygame.mouse.get_pos()): # checking if mouse is collided with the play playbutton
...
# function to generate pipes randomly
def getRandomPipe():
    '''
...
def gameOver():
    ...
    SCREEN.blit(GAME_SPRITES['HOME'], (30, 270))
    # Adding Intro Music
...
if __name__ == "__main__":
    ...
    while True:
        welcomeScreen() # shows a welcomeScreen to the user until they start the game
